...
router.get('/practice/skills', AsyncHandler(listPracticeSkills));
router.get('/practice/skills/:id', AsyncHandler(getPracticeSkillDetail));
...
router.get('/public', AsyncHandler(listPublicInterviews));
